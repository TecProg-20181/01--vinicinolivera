...
void ler_pixels_imagem(Image img, int width, int height){
...
void imprimir_pixels_imagem(Image img, int width, int height){
...
void executa_opcoes(Image img, int opcao){
  switch(opcao) {
...
int main() {
    ...
    ler_pixels_imagem(img, img.width, img.height);
    ...
    imprimir_pixels_imagem(img, img.width, img.height);
